...
public class ShellExplosion : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        //Spawn an explosion
        GameObject explosionObj = ObjectPooler.Instance.SpawnFromPool("shlexplosions", transform.position, transform.rotation);

        //Spawn an explosion
        m_ExplosionParticles = explosionObj.GetComponent<ParticleSystem>();

        //Get the audio of the explosion
        m_ExplosionAudio = explosionObj.GetComponent<AudioSource>();
        ...
        #region ReturnToNormal
        explosionObj.transform.localScale = one;
