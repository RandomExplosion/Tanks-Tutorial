...
{
    public int m_PlayerNumber = 1;              //Index used to identify the different players.
    public Rigidbody m_Shell;                   //Prefab containing the shell.
    public Transform m_FireTransform;           //A child of the tank whose location is used to spawn the shell.
